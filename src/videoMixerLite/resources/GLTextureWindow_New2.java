...
protected JInternalFrame frm;
   ...
   * @param h int
   */  
  public GLTextureWindow_New2(PApplet parent, int x, int y, int w, int h) {
    this(parent, x, y, w, h, true);
  }
  
  public GLTextureWindow_New2(PApplet parent, int x, int y, int w, int h, boolean v) {
    this(parent, "texture window", x, y, w, h, v, false, false);
  }

  public GLTextureWindow_New2(PApplet parent, int x, int y, int w, int h, boolean v, boolean b) {
   ...
   * @param r boolean          
   */
  public GLTextureWindow_New2(PApplet parent, String s, int x, int y, int w, int h, 
