 ...
 * @author User
 */
public class GLTextureWindow_New extends GLWindow  
{
   ...
   * @param h int
   */  
  public GLTextureWindow_New(PApplet parent, int x, int y, int w, int h) {
    this(parent, x, y, w, h, true);
  }
  
  public GLTextureWindow_New(PApplet parent, int x, int y, int w, int h, boolean v) {
    this(parent, "texture window", x, y, w, h, v, false, false);
  }

  public GLTextureWindow_New(PApplet parent, int x, int y, int w, int h, boolean v, boolean b) {
   ...
   * @param r boolean          
   */
  public GLTextureWindow_New(PApplet parent, String s, int x, int y, int w, int h, 
  ...
  public boolean ready() {
    return renderer.initalized && renderer.started && outTex != null;
  }  
  
  /**
   * Returns true if the window and all necessary elements have been
   * initialized.
   * 
   * @return boolean
   */   
